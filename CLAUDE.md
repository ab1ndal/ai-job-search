...
## Repo Structure
- `profiles/` - per-candidate data (identity, skills files, tracker, CVs, cover letters, documents) - see `.claude/PROFILES.md`
- `cv/` - shared LaTeX CV templates (moderncv template, banking style)
- `cover_letters/` - shared LaTeX cover letter template (custom cover.cls template)
...
3. If good fit: create targeted CV (`profiles/<name>/cv/main_<company>_<role>.tex`) and cover letter (`profiles/<name>/cover_letters/cover_<company>_<role>.tex`)
